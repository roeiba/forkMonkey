#!/usr/bin/env python3
"""
Create with_ball animation GIF from video
"""
...
VIDEO_PATH = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment2/videos/with_ball_monkey.mp4"
FRAMES_DIR = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment2/frames_with_ball"
...
def extract_frames_from_video(video_path, output_dir, fps=4):
    ...
    print(f"📹 Extracting frames from with_ball video at {fps} FPS...")
    ...
    cmd = [
        ...
        '-i', video_path,
        '-vf', f'fps={fps}',
        os.path.join(output_dir, 'ball_frame_%03d.png'),
        '-y'
    ]
    ...
    frame_files = sorted(glob.glob(os.path.join(output_dir, 'ball_frame_*.png')))
...
def create_with_ball_cycle(frame_files, output_path, cycle_length=4):
    """Create a with_ball cycle GIF - 4 frames for gentle ball play"""
    print(f"\n🎾 Creating with_ball cycle GIF...")
...
def main():
    print("="*70)
    print("🎾 CREATING WITH_BALL ANIMATION FROM VIDEO")
    print("="*70)
    ...
    # Create with_ball cycle GIF (4 frames)
    output_path = os.path.join(GIFS_DIR, "brown_with_ball_8fps.gif")
    create_with_ball_cycle(frame_files, output_path, cycle_length=4)
    ...
    exp1_ball = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment1/assets/fork-monkey/brown_with_ball_8fps.gif"
    if os.path.exists(exp1_ball):
        exp1_size = os.path.getsize(exp1_ball)
