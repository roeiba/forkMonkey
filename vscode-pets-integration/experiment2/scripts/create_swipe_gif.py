#!/usr/bin/env python3
"""
Create swipe (eating) animation GIF from video
"""
...
VIDEO_PATH = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment2/videos/swipe_monkey.mp4"
FRAMES_DIR = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment2/frames_swipe"
...
def extract_frames_from_video(video_path, output_dir, fps=4):
    ...
    print(f"📹 Extracting frames from swipe video at {fps} FPS...")
    ...
    cmd = [
        ...
        '-i', video_path,
        '-vf', f'fps={fps}',
        os.path.join(output_dir, 'swipe_frame_%03d.png'),
        '-y'
    ]
    ...
    frame_files = sorted(glob.glob(os.path.join(output_dir, 'swipe_frame_*.png')))
...
def create_swipe_cycle(frame_files, output_path, cycle_length=5):
    """Create a swipe cycle GIF - 5 frames for eating motion"""
    print(f"\n🍴 Creating swipe cycle GIF...")
...
def main():
    print("="*70)
    print("🍴 CREATING SWIPE (EATING) ANIMATION FROM VIDEO")
    print("="*70)
    ...
    # Create swipe cycle GIF (5 frames for eating motion)
    output_path = os.path.join(GIFS_DIR, "brown_swipe_8fps.gif")
    create_swipe_cycle(frame_files, output_path, cycle_length=5)
    ...
    exp1_swipe = "/home/ubuntu/forkMonkey/vscode-pets-integration/experiment1/assets/fork-monkey/brown_swipe_8fps.gif"
    if os.path.exists(exp1_swipe):
        exp1_size = os.path.getsize(exp1_swipe)
    ...
    print("\n" + "🎉"*35)
    print("🎉 ALL 5 ANIMATIONS COMPLETE! 🎉")
    print("🎉"*35)
